...
# 현재 입주 중: out_dt 없음 또는 레거시 무효 날짜
...
def _parse_bunji_input(raw, bunji1="", bunji2=""):
        ...
        if "-" in s:
            ...
            if digits:
                ...
                for r in rows or []:
                    ...
                    key_pad = f"{_pad_bunji(r.get('bunji1'))}{_pad_bunji(r.get('bunji2'))}"
...
def _building_label(bunji1, bunji2):
